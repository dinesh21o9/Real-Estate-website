...
const Post = () => {
  ...
  const offerFields = {
    ...
    independent: independentProperty,
    industrial: industrialProperty,
    commercial: commercialProperty,
    agricultural: agriculturalProperty,
    auction: auctionProperty,
  };
  const selectedFields = offerFields[selectedProp_Type][selectedOffer];

  const handleOfferChange = (e) =>{
    setSelectedOffer(e.target.value);
  };
  
  const handleProp_TypeChange = (e) =>{
    setSelectedProp_Type(e.target.value);
  };
  ...
  const handleSubmit = (event) => {
    ...
    const fields = offerFields[selectedProp_Type][selectedOffer]; 
    ...
    values['property_type'] = event.target.elements['property_type'].value;
      ...
      {isSubmitted ? (
        ...
        <div className="post-card">
          <form className="post-form" onSubmit={handleSubmit}>
            ...
            {selectedOffer && selectedProp_Type && (
              <div>
